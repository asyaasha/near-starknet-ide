...
export interface ApiObject {
  [index: string]: string | number | boolean | ApiObject | (string | number | boolean | ApiObject)[] | undefined | null;
}
...
export default interface Analytics {
  ...
  track(event: string, properties?: ApiObject, apiOptions?: ApiOptions, callback?: ApiCallback): void;
  identify(userId?: string, traits?: ApiObject, callback?: ApiCallback, apiOptions?: ApiOptions): void;
  alias(to: string, from?: string, apiOptions?: ApiOptions, callback?: ApiCallback): void;
  group(groupId?: string, traits?: ApiObject, apiOptions?: ApiOptions, callback?: ApiCallback): void;
